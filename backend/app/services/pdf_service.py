...
def _public_document(record: dict[str, object]) -> dict[str, object]:
    ...
    return {
        ...
        "handwritten_page_count": record.get("handwritten_page_count", 0),
        "low_quality_page_count": record.get("low_quality_page_count", 0),
        "table_count": record.get("table_count", 0),
        "average_text_quality": record.get("average_text_quality"),
        "extraction_warning_count": record.get("extraction_warning_count", 0),
